 ...
 * {@link Association} to which this role belongs to.
 *
 * @package core
 * @author Johannes Schmidt <phptmapi-discuss@lists.sourceforge.net>
 * @version svn:$Id: Role.interface.php 90 2011-09-15 15:58:49Z joschmidt $
 */
interface Role extends Reifiable, Typed
{
   ...
   *
   * @return Topic The topic playing this role.
   */
   ...
   * @return void
   * @throws {@link ModelConstraintException} If <var>$player</var> does not belong 
