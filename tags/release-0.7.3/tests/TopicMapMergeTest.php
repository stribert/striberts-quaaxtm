...
{
  protected static $_tmLocator2 = 'http://localhost/tm/2';
  ...
  protected function setUp() {
    parent::setUp();
    $this->_tm1 = $this->_topicMap;
    $this->_tm2 = $this->_sharedFixture->createTopicMap(self::$_tmLocator2);
  }
  ...
  public function testTopicMap() {
    $this->assertTrue($this->_tm1 instanceof TopicMap);
    $this->assertTrue($this->_tm2 instanceof TopicMap);
  }
  ...
  public function testMergeByItemIdentifier() {
    ...
    $topic1 = $this->_tm1->createTopicByItemIdentifier($iid);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopicByItemIdentifier($iid);
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getConstructByItemIdentifier($iid)->getId(), 'Expected identity!');
    ...
    $this->assertEquals($topic2->getId(), 
      $this->_tm2->getConstructByItemIdentifier($iid)->getId(), 'Expected identity!');
  ...
  public function testMergeBySubjectIdentifier() {
    ...
    $topic1 = $this->_tm1->createTopicBySubjectIdentifier($sid);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopicBySubjectIdentifier($sid);
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getTopicBySubjectIdentifier($sid)->getId(), 'Expected identity!');
    ...
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic2->getId(), 
      $this->_tm2->getTopicBySubjectIdentifier($sid)->getId(), 'Expected identity!');
  ...
  public function testMergeBySubjectLocator() {
    ...
    $topic1 = $this->_tm1->createTopicBySubjectLocator($slo);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopicBySubjectLocator($slo);
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getTopicBySubjectLocator($slo)->getId(), 'Expected identity!');
    ...
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic2->getId(), 
      $this->_tm2->getTopicBySubjectLocator($slo)->getId(), 'Expected identity!');
  ...
  public function testMergeItemIdentifierEqualSubjectIdentifier() {
    ...
    $topic1 = $this->_tm1->createTopicByItemIdentifier($loc);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopicBySubjectIdentifier($loc);
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getConstructByItemIdentifier($loc)->getId(), 'Expected identity!');
    $this->assertNull($this->_tm1->getTopicBySubjectIdentifier($loc), 'Unexpected topic!');
    ...
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getConstructByItemIdentifier($loc)->getId(), 'Expected identity!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getTopicBySubjectIdentifier($loc)->getId(), 'Expected identity!');
    $this->assertEquals(count($topic1->getItemIdentifiers()), 1, 
      'Expected 1 item identifier!');
    $this->assertEquals(count($topic1->getSubjectIdentifiers()), 1, 
      'Expected 1 subject identifier!');
    ...
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic2->getId(), 
      $this->_tm2->getTopicBySubjectIdentifier($loc)->getId(), 'Expected identity!');
    $this->assertNull($this->_tm2->getConstructByItemIdentifier($loc), 
  ...
  public function testMergeSubjectIdentifierEqualItemIdentifier() {
    $loc = 'http://phptmapi.sourceforge.net/';
    $topic1 = $this->_tm1->createTopicBySubjectIdentifier($loc);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopicByItemIdentifier($loc);
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getTopicBySubjectIdentifier($loc)->getId(), 'Expected identity!');
    $this->assertNull($this->_tm1->getConstructByItemIdentifier($loc), 
      'Unexpected construct!');
    ...
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic2->getId(), 
      $this->_tm2->getConstructByItemIdentifier($loc)->getId(), 'Expected identity!');
    $this->assertNull($this->_tm2->getTopicBySubjectIdentifier($loc), 'Unexpected topic!');
    $this->assertEquals(count($topic2->getItemIdentifiers()), 1, 
      'Expected 1 item identifier!');
    $iids = $topic2->getItemIdentifiers();
    $this->assertTrue(in_array($loc, $iids), 'Expected certain item identifier!');
  ...
  public function testAddTopicsFromOtherMap() {
    ...
    $topic1 = $this->_tm1->createTopicByItemIdentifier($loc1);
    $topic2 = $this->_tm2->createTopicByItemIdentifier($loc2);
    
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic1->getId(), 
      $this->_tm1->getConstructByItemIdentifier($loc1)->getId(), 'Expected identity!');
    $this->assertNull($this->_tm1->getConstructByItemIdentifier($loc2), 
      'Unexpected construct!');
      
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals($topic2->getId(), 
      $this->_tm2->getConstructByItemIdentifier($loc2)->getId(), 'Expected identity!');
    $this->assertNull($this->_tm2->getConstructByItemIdentifier($loc1), 
      'Unexpected construct!');
      
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 2, 'Expected 2 topics!');
    $iids = $topic1->getItemIdentifiers();
    ...
    $newTopic = $this->_tm1->getConstructByItemIdentifier($loc2);
  ...
  public function testMergeTypes() {
    $topic1 = $this->_tm1->createTopic();
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopic();
    $topic3 = $this->_tm2->createTopic();
    $type = $this->_tm2->createTopicBySubjectIdentifier('http://google.com');
    $topic2->addType($type);
    $topic3->addType($type);
    $this->assertEquals(count($this->_tm2->getTopics()), 3, 'Expected 3 topics!');
    $this->assertEquals(count($topic2->getTypes()), 1, 'Expected 1 type!');
    $this->assertEquals(count($topic3->getTypes()), 1, 'Expected 1 type!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 4, 'Expected 4 topics!');
    $this->assertEquals(count($this->_tm2->getTopics()), 3, 'Expected 3 topics!');
    $this->assertEquals(count($topic2->getTypes()), 1, 'Expected 1 type!');
    $this->assertEquals(count($topic3->getTypes()), 1, 'Expected 1 type!');
    $types = array();
    $topics = $this->_tm1->getTopics();
  ...
  public function testMergeTypes2() {
    ...
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopic();
    $type = $this->_tm2->createTopic();
    $topic2->addType($type);
    $this->assertEquals(count($this->_tm2->getTopics()), 2, 'Expected 2 topics!');
    $this->assertEquals(count($topic2->getTypes()), 1, 'Expected 1 type!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 3, 'Expected 3 topics!');
    $this->assertEquals(count($this->_tm2->getTopics()), 2, 'Expected 2 topics!');
    $this->assertEquals(count($topic2->getTypes()), 1, 'Expected 1 type!');
    $types = array();
    $topics = $this->_tm1->getTopics();
  ...
  public function testMergeNameVariant() {
    ...
    $topic = $this->_tm2->createTopicBySubjectIdentifier($sid1);
    $slo = 'http://localhost/slo/topic' . uniqid();
    $variantReifier = $this->_tm2->createTopicBySubjectlocator($slo);
    $sid2 = 'http://localhost/sid/topic' . uniqid('2');
    $theme = $this->_tm2->createTopicBySubjectIdentifier($sid2);
    $name = $topic->createName('foo');
    $variant = $name->createVariant('bar', parent::$_dtString, array($theme));
    ...
    $this->assertEquals(count($this->_tm1->getTopics()), 0);
    $this->_tm1->mergeIn($this->_tm2);
    $topic = $this->_tm1->getTopicBySubjectIdentifier($sid1);
    ...
    $this->assertEquals(
      ...
      $this->_tm1->getTopicBySubjectLocator($slo)->getId()
    );
    ...
    $this->assertEquals(
      $theme->getId(),
      $this->_tm1->getTopicBySubjectIdentifier($sid2)->getId()
    );
  ...
  public function testMergeOccurrence() {
    ...
    $topic2 = $this->_tm2->createTopic();
    $type = $this->_tm2->createTopic();
    $reifier = $this->_tm2->createTopic();
    $occ = $topic2->createOccurrence($type, 'Occurrence', parent::$_dtString);
  ...
  public function testMergeOccurrence2() {
    $topic1 = $this->_tm1->createTopic();
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $topic2 = $this->_tm2->createTopicBySubjectIdentifier('http://google.com');
    $type = $this->_tm2->createTopicByItemidentifier('http://localhost/t/1');
    $topic2->createOccurrence($type, 'Occurrence', parent::$_dtString);
    $topic2->createOccurrence($type, 'Occurrence 2', parent::$_dtString);
    ...
    $formerTopic2 = $this->_tm1->getTopicBySubjectIdentifier('http://google.com');
    ...
    $this->assertEquals($occ1->getDatatype(), parent::$_dtString, 
      'Unexpected occurrence datatype!');
    $this->assertEquals($occ2->getDatatype(), parent::$_dtString, 
      'Unexpected occurrence datatype!');
      
    // merge has no effect on merged tm 2
    $topic2 = $this->_tm2->getTopicBySubjectIdentifier('http://google.com');
  ...
  public function testMergeReifier() {
    $reifier1 = $this->_tm1->createTopicByItemidentifier('http://localhost/t/1');
    $reifier2 = $this->_tm2->createTopicByItemidentifier('http://localhost/t/2');
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $this->_tm1->setReifier($reifier1);
    $this->_tm2->setReifier($reifier2);
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 1, 'Expected 1 topic!');//reifiers are merged
    $this->assertEquals(count($this->_tm2->getTopics()), 1, 'Expected 1 topic!');
    $_reifier1 = $this->_tm1->getReifier();
    $this->assertTrue($_reifier1 instanceof Topic, 'Expected reifier!');
    $_reifier2 = $this->_tm2->getReifier();
  ...
  public function testMergeAssociation() {
    $type = $this->_tm2->createTopic();
    $scope = array($this->_tm2->createTopic(), $this->_tm2->createTopic());
    $assoc = $this->_tm2->createAssociation($type, $scope);
    $this->assertEquals(count($this->_tm1->getTopics()), 0, 'Expected 0 topics!');
    $this->assertEquals(count($this->_tm2->getTopics()), 3, 'Expected 3 topics!');
    $this->assertEquals(count($this->_tm2->getAssociations()), 1, 'Expected 1 association!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 3, 'Expected 3 topics!');
    $this->assertEquals(count($this->_tm1->getAssociations()), 1, 'Expected 1 association!');
    $assocs = $this->_tm1->getAssociations();
    $assoc = $assocs[0];
    ...
    $this->assertEquals(count($this->_tm2->getTopics()), 3, 'Expected 3 topics!');
    $this->assertEquals(count($this->_tm2->getAssociations()), 1, 'Expected 1 association!');
    $_assocs = $this->_tm2->getAssociationsByType($type);
    $_assoc = $_assocs[0];
  ...
  public function testMergeAssociationRole() {
    $assocType = $this->_tm2->createTopic();
    $scope = array($this->_tm2->createTopic(), $this->_tm2->createTopic());
    $assoc = $this->_tm2->createAssociation($assocType, $scope);
    $role = $assoc->createRole($this->_tm2->createTopic(), $this->_tm2->createTopic());
    $this->assertEquals(count($this->_tm1->getTopics()), 0, 'Expected 0 topics!');
    $this->assertEquals(count($this->_tm2->getTopics()), 5, 'Expected 5 topics!');
    $this->assertEquals(count($this->_tm2->getAssociations()), 1, 'Expected 1 association!');
    $this->assertEquals(count($assoc->getRoles()), 1, 'Expected 1 association role!');
    $this->_tm1->mergeIn($this->_tm2);
    $this->assertEquals(count($this->_tm1->getTopics()), 5, 'Expected 5 topics!');
    $this->assertEquals(count($this->_tm1->getAssociations()), 1, 'Expected 1 association!');
    $assoc = null;
    $assocs = $this->_tm1->getAssociations();
    $assoc = $assocs[0];
    ...
    $this->assertEquals(count($this->_tm2->getTopics()), 5, 'Expected 5 topics!');
    $this->assertEquals(count($this->_tm2->getAssociations()), 1, 'Expected 1 association!');
    $_assocs = $this->_tm2->getAssociationsByType($assocType);
    $_assoc = $_assocs[0];
    $this->assertTrue($_assoc->getType() instanceof Topic, 'Expected association type!');
    $this->assertEquals(count($_assoc->getScope()), 2, 'Expected 2 themes!');
  ...
  public function testGainReifier() {
    ...
    $reifier = $this->_tm2->createTopicBySubjectIdentifier($sid);
    $this->_tm2->setReifier($reifier);
    $this->_tm1->mergeIn($this->_tm2);
    $gainedReifier = $this->_tm1->getReifier();
